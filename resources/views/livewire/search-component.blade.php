    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                ...
                @if ($products->count() > 0)
                @else
                <p class="text-danger pt-3">No product Found!!!</p>                    
                @endif
                <div class="row">
                            ...
                            <div class="product product-style-3 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{route('product.details', $product->slug)}}" title="{{$product->name}}">
                                        <figure title="{{$product->category_id}}"><img src="{{asset('assets/images/products/'. $product->image)}}" alt="{{$product->name}}"></figure>
                                    </a>
                                </div>
                                <div class="product-info">
                                    <a href="{{route('product.details', $product->slug)}}" class="product-name text-capitalize"><span>{{$product->name}}</span></a>
                                    <div class="wrap-price"><span class="product-price">${{$product->regular_price}}</span></div>
                                    <a href="#" title="{{$product->category_id}}" wire:click.prevent="store({{$product->id}}, '{{$product->name}}', {{$product->regular_price}})" class="btn add-to-cart">Add To Cart</a>
                                </div>
                            </div>
                        </li>
                        @endforeach
