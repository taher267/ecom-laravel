                ...
                <div class="panel-body">
                    <div class="card text-white bg-dark my-3 mx-auto" style="max-width: 18rem;">
                        ...
                        <div class="card-body transaction-body">
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <form class="">
                                        ...
                                        <select id="order_status_change" class="btn-sm text-capitalize form-control" name="status" wire:model="status">
                                            @php
                                                $options=[
                                          ...
                                          <button id="change_btn" style="" type="submit" class="btn btn-info btn-sm mt-2">Submit</button>
                                      </form>
                                  </td>
                              </tr>
                              <tr>
                          ...
                          {{-- <p class="card-text d-flex"><b style=""><b><i class="fas fa-file-invoice-dollar"></i></b> {{ $order->transaction->mode=='cod' ? 'Cash On Delivery': '' }}</p>
                          <p class="card-text d-flex"><b><i class="fas fa-thermometer-quarter"></i></b> {{ $order->transaction->status}}</p>
                          <p class="card-text d-flex"><b><i class="fas fa-calendar-alt"></i> </b> {{ $order->transaction->created_at}}</p> --}}
                        </div>
                    </div>
                    {{-- <div class="w-50 mx-auto row">
                        <div class="col-lg-6 fw-bold">Customer Name</div>
                        <div class="col-lg-6">{{$order->user->name}}</div>
                        <div class="col-lg-6 fw-bold">Payment By/Method</div>
                        <div class="col-lg-6">{{$order->transaction->mode=='cod' ? 'Cash On Delivery': '' }}</div>
                    </div> --}}
                    {{-- <div class="col-lg-12">
                        <table class="table table-striped">
                            <tr>
